pub const DOMAINE_NOM: &str = "Hebergement";
pub const COLLECTION_NOM: &str = DOMAINE_NOM;

pub const COLLECTION_CLIENTS_NOM: &str = "Hebergement/clients";
pub const COLLECTION_FICHIERS_NOM: &str = "Hebergement/fichiers";
